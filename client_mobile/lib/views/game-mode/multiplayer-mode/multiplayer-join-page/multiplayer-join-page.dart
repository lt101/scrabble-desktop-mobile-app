...
import 'package:client_leger/views/game-mode/multiplayer-mode/multiplayer-join-page/multiplayer-join-card.dart';
import 'package:flutter/material.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';
import 'package:get_it/get_it.dart';

class MultiPlayerJoinPage extends StatefulWidget {
  const MultiPlayerJoinPage({super.key});

  @override
  State<MultiPlayerJoinPage> createState() => _MultiPlayerJoinPageState();
}

class _MultiPlayerJoinPageState extends State<MultiPlayerJoinPage> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: const SingleChildScrollView(
            reverse: true, child: MultiPlayerJoinCard()),
      ),
    );
  }
